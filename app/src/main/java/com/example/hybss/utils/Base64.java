...
//        } else {
//            // 三星等部分设备修改了SDK的Base64，导致encode结果末尾会多一个0x0a（换行）
//            try {
//                Class<?> c = Class.forName("android.util.Base64");
//                return ReflectUtils.invokeStatic(String.class, c, "encodeToString",
//                        new Class[] { byte[].class, int.class }, new Object[] { data, c.getField("DEFAULT").get(c) });
//            } catch (Exception e) {
//                LogUtils.e(e);
//                return new String(encodeInner(data));
//            }
...
//            try {
//                Class<?> c = Class.forName("android.util.Base64");
//                byte byteData[] = ReflectUtils.invokeStatic(byte[].class, c, "decode", new Class[] { String.class,
//                        int.class }, new Object[] { data, c.getField("DEFAULT").get(c) });
